...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.Length)(1, 50, { message: 'Category must be between 1 and 50 characters' }),
    __metadata("design:type", String)
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsDateString)({ strict: true }, { message: 'Target date must be in ISO 8601 format (YYYY-MM-DD)' }),
    __metadata("design:type", String)
], CreateGoalDto.prototype, "target_date", void 0);
